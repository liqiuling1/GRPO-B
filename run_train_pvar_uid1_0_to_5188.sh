...
LOG_FILE="logs/train_pvar_uid1_0_to_5188_${TIME}.log"
...
SAMPLE_COUNT=$((MAX_UID1 - MIN_UID1 + 1))
PROMPTS_PER_STEP=$(((PER_DEVICE_TRAIN_BATCH_SIZE * GRADIENT_ACCUMULATION_STEPS) / NUM_GENERATIONS))
DEFAULT_MAX_STEPS=$(((SAMPLE_COUNT + PROMPTS_PER_STEP - 1) / PROMPTS_PER_STEP))
MAX_STEPS="${MAX_STEPS:-${DEFAULT_MAX_STEPS}}"

echo "==== GRPO Training From PVar-Sorted Scores Start ===="
echo "Log: ${LOG_FILE}"
...
echo "==== GRPO Training From PVar-Sorted Scores Finished ===="
